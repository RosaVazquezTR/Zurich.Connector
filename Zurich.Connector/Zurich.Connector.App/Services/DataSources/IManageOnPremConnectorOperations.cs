...
{
    public class IManageOnPremConnectorOperations : IConnectorDataSourceOperations
    {
        ...
        public IManageOnPremConnectorOperations(ILogger<IConnectorDataSourceOperations> logger, IDataMappingFactory dataMappingFactory, IMapper mapper, ICosmosService cosmosService)
        {
            _logger = logger;
            _mapper = mapper;
        ...
        {
            return appCode == KnownDataSources.iManageOnPrem;
        }
